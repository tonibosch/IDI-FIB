...
void MyGLWidget::calcul_punts(){
  xcentre_capsa = (xmax+xmin)/2.0;
  ycentre_capsa = (ymax+ymin)/2.0;
  zcentre_capsa = (zmax+zmin)/2.0;
...
void MyGLWidget::projectTransform() {
    ...
    glm::mat4 Proj = glm::perspective (fov, 1.0f, znear, zfar);        //
...
void MyGLWidget::viewTransform() {
    ...
    View = glm::lookAt (glm::vec3(xobs,yobs,d), glm::vec3(xcentre_capsa,ycentre_capsa,zcentre_capsa), glm::vec3(xup,yup,zup));
