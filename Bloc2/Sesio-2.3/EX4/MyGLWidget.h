...
class MyGLWidget : public BL2GLWidget {
  ...
  private:
    ...
    void creaBuffers();
    void carregaShaders();
    void modelTransform_Patricio1();
    void modelTransform_Patricio2();
    void modelTransform_Patricio3();
    ...
    float R, d, znear, zfar, fov, rav, left, right, bottom, top;
