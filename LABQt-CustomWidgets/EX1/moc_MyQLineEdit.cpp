...
QT_MOC_LITERAL(1, 12, 13), // "returnPressed"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 12) // "tractaReturn"

    },
    "MyQLineEdit\0returnPressed\0\0tractaReturn"
};
...
void MyQLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MyQLineEdit *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (MyQLineEdit::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyQLineEdit::returnPressed)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MyQLineEdit::staticMetaObject = { {
...
// SIGNAL 0
void MyQLineEdit::returnPressed(const QString & _t1)
{
